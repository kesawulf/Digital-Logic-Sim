...
public class Wire : MonoBehaviour
{
    ...
    public Pin ChipInputPin => (startPin.pinType == PinType.ChipInput) ? startPin : endPin;

    public Pin ChipOutputPin => (startPin.pinType == PinType.ChipOutput) ? startPin : endPin;
